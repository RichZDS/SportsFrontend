...
- 配置后端地址：在 `.env.development` 设置 `VITE_API_BASE=http://localhost:8080`
...
## 说明
- Axios 基于 `VITE_API_BASE`
- 图表组件位于 `src/components/Chart.jsx`
=======
# 消费管理系统（Ant Design + Spring Boot）
...
>>>>>>> b6918fa090025f48e099d1eb32645a36feaa1fd8
